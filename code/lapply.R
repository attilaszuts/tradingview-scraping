...
sold <- knitr::imgur_upload(oversold.filename, key = "5ebfae97e9caee6")
soldurl <- sold[1]

bought <- knitr::imgur_upload(overbought.filename, key = "5ebfae97e9caee6")
boughturl <- bought[1]

# send message to discord  ------------------------------------------------

# webhook to channel
webhookurl <- 'https://discord.com/api/webhooks/787802743375921192/yHRIa3bqrXlkwcFS7-v1Cy-Jdr2mJVJdJ7SqFrX8ir5Y_X73AR6dLuw_iBhfc6RzwgM6'
...
ati <- '<@242617935582068736>'
robi <- '<@359760472028741634>'
